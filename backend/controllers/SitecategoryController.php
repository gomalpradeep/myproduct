...
use common\models\SiteCategorySearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * SitecategoryController implements the CRUD actions for SiteCategory model.
 */
class SitecategoryController extends Controller
{
    ...
    {
        $searchModel = new SiteCategorySearch();
